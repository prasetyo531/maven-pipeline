...
//		System.out.println("window parent"+""+parent);
//		
		logpro.registerFacebook().click();
//		
//		String parent1=driver.getWindowHandle();
//		System.out.println(driver.getCurrentUrl());
//		System.out.println("window parent"+""+parent1);
//		
//		driver.switchTo().window(parent1);
		...
		(new WebDriverWait(driver, 5)).until(ExpectedConditions.elementToBeClickable(By.cssSelector("button[value='1']")));
		...
		(new WebDriverWait(driver, 5)).until(ExpectedConditions.textToBePresentInElementValue(logpro.fillEmail(), email));
...
//		asserComProf.waitskintypeload();
	...
	public Object[][] existingCust() throws Exception {
		...
		Sheet sheet = wb.getSheet("register facebook");
