...
public class nyoba extends Controller {
	...
	public void scenario_satu(String email,String password,String alamat,String telepon) throws Exception {
		...
		if(testenv.equalsIgnoreCase("prod")){
        	driver.navigate().to("https://www.phptravels.net/");  //https://dev.uangteman.com/a/NHeHv
		...
		driver.findElement(By.cssSelector("input[class='form-control input-lg dpd1'")).sendKeys("05/09/2018");
		driver.findElement(By.cssSelector("input[class='form-control input-lg dpd2'")).sendKeys("08/09/2018");
		
		driver.findElement(By.cssSelector("button[class='btn btn-lg btn-block btn-danger pfb0 loader'")).click();
		

		List<WebElement> radiobtn = driver.findElementsByCssSelector("div[class='hpadding20'");
		System.out.println(radiobtn.size());
		radiobtn.get(new Random().nextInt(radiobtn.size())).click();
